...
define([
    ...
    'String',
    'jquery_ui'
], function(_, $, Backbone, _commonObject, Util, String) {
    ...
    object.doSearch = function() {
        ...
        $.ajax({
            ...
            url: "/searchOAuth",
            dataType: 'json',
            data: { searchKey: searchKey, status: status, order: sort, page: page },
            success: function(data, status) {
                ...
                if (status == 'success') {
                    if (data.result) {
                        ...
                        $("#list").append(window.JST['assets/templates/oauthlist.html']({
                            list: data.result,
                            Util: Util,
                            String: String
                        }));
